...
using Shipping.ShippingLabels;
using Shipping.Utils;
using Shipping.Identity;

namespace Shipping
{
    public sealed class ShippingDbContext : IdentityDbContext
        <ShippingUser, ShippingRole, string, IdentityUserClaim<string>,
        ShippingUserRole, IdentityUserLogin<string>, IdentityRoleClaim<string>, IdentityUserToken<string>>
    {
        ...
        //public DbSet<ShippingLable> ShippingLables { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfiguration(new ShippingUserConfig());
            builder.ApplyConfiguration(new ShippingUserRoleConfig());
